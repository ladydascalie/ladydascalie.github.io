...
function showSystemMessage(message, type = "info") {
        ...
        right: 20px;
        background: rgba(0, 0, 0, 0.9);
        border: 1px solid ${type === "error" ? "#ff0040" : type === "warning" ? "#ff6b00" : "#00ff41"};
        ...
        font-size: 12px;
        z-index: 10000;
        box-shadow: 0 0 10px ${type === "error" ? "rgba(255, 0, 85, 0.3)" : type === "warning" ? "rgba(255, 119, 0, 0.3)" : "rgba(0, 255, 255, 0.3)"};
        max-width: 300px;
        word-wrap: break-word;
    `;
